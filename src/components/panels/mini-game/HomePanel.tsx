...
export const HomePanel = () => {
  ...
  const homeContent = (
    <div className="flex flex-col w-full bg-[#fffeec] rounded-b-[20px] rounded-t border border-gray-20 absolute z-10 !min-h-[calc(100%-32px)] !h-[calc(100%-32px)] overflow-hidden mt-8">
      {/* <Slider ranks={[]} /> */}
  ...
  return (
    <>
      <div className="list-panel bg-[#2e2e2e] w-full h-full absolute z-10 p-4 top-0">
        <div className="rounded-3xl border-solid border-orange-90 border-4 !min-h-[calc(100%-36px)] !h-[calc(100%-36px)] mt-6">
