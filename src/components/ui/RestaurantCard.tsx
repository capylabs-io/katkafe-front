...
const RestaurantCard = ({ restaurant, onUnlock, onCardClick }: Props) => {
  const [nextRestaurantUnclockIndex, myRestaurants, currentRestaurant] =
  ...
  return (
    <div
      className="relative flex flex-col justify-center items-center min-h-[198px]"
